...
nav_order: 5
description: "Reference for built-in tools available to skills running on the QuickCreator platform."
---

# Available Tools for Generated Skills
{: .no_toc }

Built-in tools available to skills that run on the QuickCreator platform. Use this reference when creating or editing skills with the skill builder.
{: .fs-6 .fw-300 }
...
A reusable template script is provided at [scripts/generate_video.py](https://github.com/kycloudtech/quickcreator-skills/blob/master/quickcreator-skill-builder/scripts/generate_video.py).
